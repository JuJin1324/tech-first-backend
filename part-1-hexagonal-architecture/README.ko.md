# Part 1: 헥사고날 아키텍처 (Hexagonal Architecture)
...
1.  **애플리케이션 실행:**
    -   `part-1-hexagonal-architecture` > `src` > `main` > `java` > `com.techfirst.backend.hexagonal` 경로로 이동하여 `HexagonalApplication.java` 파일을 찾습니다.
