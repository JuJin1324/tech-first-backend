...
class CustomerSoapEndpointTest {
    ...
    void getCustomer_ShouldReturnCustomerXml() throws Exception {
        ...
        Source requestPayload = new StringSource(
                "<ns2:getCustomerRequest xmlns:ns2=\"http://techfirst.com/backend/restsoap/soap\">" +
        ...
        mockClient.sendRequest(withPayload(requestPayload))
                .andExpect(xpath("/ns2:getCustomerResponse/ns2:id",
                        java.util.Collections.singletonMap("ns2", "http://techfirst.com/backend/restsoap/soap"))
                        .evaluatesTo("1"))
